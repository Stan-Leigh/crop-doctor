...
try:
    ...
    print(f"Warning: Cloud telemetry/logging disabled (no Google Cloud credentials found: {e})")
    project_id = "local-project"
    class LocalLogger:
        def log_struct(self, data, severity="INFO"):
            print(f"[{severity}] Audit Log: {data}")
    logger = LocalLogger()
...
app.title = "crop-doctor"
app.description = "API for interacting with the Agent crop-doctor"

from fastapi.staticfiles import StaticFiles
frontend_path = os.path.join(AGENT_DIR, "frontend")
app.mount("/custom", StaticFiles(directory=frontend_path, html=True), name="custom-frontend")
